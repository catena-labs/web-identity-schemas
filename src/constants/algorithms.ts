/**
 * Shared algorithm constants for JOSE specifications.
 ...
 */
export const joseSignatureAlgorithms = [
 ...
 */
export const joseUnsecuredAlgorithm = "none" as const
 ...
 */
export const jweContentEncryptionAlgorithms = [
 ...
 */
export const jweKeyManagementAlgorithms = [
  // RSA PKCS#1 v1.5
  "RSA1_5",
  // RSA OAEP
  "RSA-OAEP",
